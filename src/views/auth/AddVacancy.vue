      ...
      <div class="container-fluid p-4">
        ...
        <div class="row">
          ...
          <ValidationObserver v-slot="{ handleSubmit }">
            <form v-if="permissions.vacancy_permission == 'enabled'" @submit.prevent="handleSubmit(submitForm)"
              class="rowpt-70">
              <!-- Col -->
              <div class="col-12">
                <div class="card">
                    ...
                    <form class="row">
                      ...
                      <div class="form-group col-12 col-md-6">
                        <ValidationProvider name="Categories" rules="required" v-slot="{ errors }">
                          ...
                          <v-select v-if="sphere == true" v-model="form.sphere" class="lss-form-select"
                            placeholder="აირჩიეთ კატეგორია" label="text" :options="SphereData" data-bs-toggle="modal"
                            data-bs-target="#sphere"></v-select>
                          <v-select v-if="sphere == false" v-model="form.sphere" class="lss-form-select"
                            placeholder="აირჩიეთ კატეგორია" label="text" :options="SphereData"></v-select>
                          <span class="text-danger" v-if="errors[0]">აუცილებელი ველი</span>
                      ...
                      <div class="form-group col-12 col-md-6">
                        <ValidationProvider name="Experience" rules="required" v-slot="{ errors }">
                          ...
                          <v-select v-if="workExperience == true" class="lss-form-select"
                            placeholder="იგივე პოზიციაზე მუშაობის გამოცდილება" label="text"
                            v-model="form.work_experience" :options="WorkExperienceData" data-bs-toggle="modal"
                            data-bs-target="#workExperience"></v-select>
                          <v-select v-if="workExperience == false" class="lss-form-select"
                            placeholder="იგივე პოზიციაზე მუშაობის გამოცდილება" label="text"
                            v-model="form.work_experience" :options="WorkExperienceData"></v-select>
                          <span class="text-danger" v-if="errors[0]">აუცილებელი ველი</span>
                      ...
                      <!-- Col -->
                      <div class="form-group col-12 col-md-9" v-if="salary != '1' && salary != '2' && salary != '3'">
                        <ValidationProvider name="Vacancy Fixed Variable max amount" rules="required"
                          ...
                          <div class="row" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <div class="col-12 col-md-4">
                              <input type="radio" class="btn-check show" name="salary" id="salary1" autocomplete="off"
                                @click="salaryAmount('1')" :class="{ show: salary == '1' }" data-bs-toggle="modal"
                                data-bs-target="#salary">
                              <label class="btn btn-outline-primary w-100" for="salary1">ფიქსირებული + ბონუსი</label>
                            </div>

                            <div class="col-12 col-md-4">
                              <input type="radio" class="btn-check" name="salary" id="salary2" autocomplete="off"
                                @click="salaryAmount('2')" :class="{ show: salary == '2' }" data-bs-toggle="modal"
                                data-bs-target="#salary">
                              <label class="btn btn-outline-primary w-100" for="salary2">გამომუშავებით</label>
                            </div>

                            <div class="col-12 col-md-4">
                              <input type="radio" class="btn-check" name="salary" id="salary3" autocomplete="off"
                                @click="salaryAmount('3')" :class="{ show: salary == '3' }" data-bs-toggle="modal"
                                data-bs-target="#salary">
                      ...
                      <div class="form-group col-12 col-md-9" v-if="salary == '1' || salary == '2' || salary == '3'">
                        ...
                        <div class="row" role="group" aria-label="Basic radio toggle button group">
                          ...
                          <div class="col-12 col-md-4">
                            <input :checked="salary == '1'" type="radio" class="btn-check show" name="salary"
                              id="salary1" autocomplete="off" @click="salaryAmount('1')"
                              :class="{ show: salary == '1' }">
                            <label class="btn btn-outline-primary w-100" for="salary1">ფიქსირებული + ბონუსი</label>
                          </div>

                          <div class="col-12 col-md-4">
                            <input :checked="salary == '2'" type="radio" class="btn-check" name="salary" id="salary2"
                              autocomplete="off" @click="salaryAmount('2')" :class="{ show: salary == '2' }">
                            <label class="btn btn-outline-primary w-100" for="salary2">გამომუშავებით</label>
                          </div>

                          <div class="col-12 col-md-4">
                            <input :checked="salary == '3'" type="radio" class="btn-check" name="salary" id="salary3"
                              autocomplete="off" @click="salaryAmount('3')" :class="{ show: salary == '3' }">
                            <label class="btn btn-outline-primary w-100" for="salary3">მხოლოდ ფიქსირებული</label>
                          </div>
                        </div>
                              ...
                              <div class="form-group col-6">
                                <ValidationProvider name="Vacancy Variable min amount" rules="required"
                                  ...
                                  <label class="font-weigt-bold" for="vacancy-Variable-min-amount">მინ. საშუალო თანხა
                                    <small class="text-muted">(ხელზე ასაღები)</small></label>
                                  <input id="vacancy-Variable-min-amount" v-model="form.min_amount"
                              ...
                              <div class="form-group col-6">
                                <ValidationProvider name="Vacancy Variable max amount" rules="required"
                                  ...
                                  <label class="font-weigt-bold" for="vacancy-Variable-max-amount">მაქს. საშუალო თანხა
                                    <small class="text-muted">(ხელზე ასაღები)</small></label>
                                  <input id="vacancy-Variable-max-amount" v-model="form.max_amount"
                                    onkeydown="return event.keyCode !== 69" class="form-control" type="number"
                                    placeholder="-მდე">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
              @click="sphereAction">გასაგებია</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="workExperience" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
              @click="workExperienceAction">გასაგებია</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="what_to_do" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
              @click="what_to_doAction">გასაგებია</button>
          </div>
        </div>
      </div>
    </div>
