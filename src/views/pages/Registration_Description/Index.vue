    ...
    <div v-show="!isLoading" class="main" :class="this.$store.state.showTopMenu== true ? 'collapsed ' : 'uncollapsed'">
      <div class="container-fluid p-4">
        ...
        <div class="row mb-3">
          <!-- Col -->
          <div class="col-6">
            <h1 class="page-title">რეგისტრაციის გვერდის აღწერილობა</h1>
          </div>
          <!-- End Col -->
          <!-- Col -->
          <div class="col-6 text-end">
            <router-link to="/RegistrationInfoCreate">
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center bg-light">
            ...
            <div class="input-group w-50">
              ...
              <button class="btn btn-outline-primary" @click="getResults()" type="button" id="button-addon2"><i class="tio-search"></i></button>
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12 mt-2">
                ...
                <table class="table">
                  <tbody>
                  <tr v-for="post in getData" :key="post.id">
                    <td>
                      <div class="row align-items-center">
                        ...
                        <div class="col-4 d-flex justify-content-end">
                          ...
                          <div class="btn btn-danger" data-bs-toggle="modal" :data-bs-target="'#deletePosition_'+post.id">
...
export default {
  ...
  methods: {
    ...
    getResults(page = 1) {
      ...
      axios.get(process.env.VUE_APP_BACKEND_URL+'/auth/RegGroup/loadData' +'?page=' + page,{
        params: {
    ...
    deleteDataById(id){
      const token = JSON.parse(localStorage.getItem('user')).access_token;
      axios.delete(process.env.VUE_APP_BACKEND_URL+'/auth/RegGroup/delete/'+id, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      })
    ...
    EditDetail(id){
      this.$router.push({ name: 'RegistrationInfoEdit', params: { id: id  } })
    },
  }
}
</script>
