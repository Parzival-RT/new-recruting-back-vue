  ...
  <div>
    ...
    <div class="main" :class="this.$store.state.showTopMenu== true ? 'collapsed ' : 'uncollapsed'">
      <div class="container-fluid p-4">
        <div class="card">
          <h5 class="card-header bg-transparent">კომპანიის მართვა</h5>
          <div class="card-body">
            ...
            <form @submit.prevent="handleSubmit(submitForm)" class="rowpt-70">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input  type="text" v-model="profile_name" disabled class="form-control" placeholder="სახელი გვარი">
                ...
                <div class="col-md-6 mt-3 mt-md-0">
                  ...
                  <input  type="text" v-model="profile_mobile" disabled class="form-control" placeholder="მობილური">
                  <span  class="text-danger">{{ errors[0] }}</span>
                ...
                <div class="col-md-6 mt-3">
                  ...
                  <label>ბრენდის დასახელება <i class="tio-info-outined text-primary" v-b-tooltip.hover title="თქვენი კომპანიის ბრენდი, ანუ სავაჭრო ნიშანი რითაც ის არის ცნობილი მომხმარებლებისათვის"></i></label>
                ...
                <div class="col-md-6 mt-3">
                  <label>ვებ გვერდი <i class="tio-info-outined text-primary" v-b-tooltip.hover title="შეიყვანეთ სწორი ფორმით მაგ: motivation.ge"></i></label>
                  <input type="url" class="form-control" v-model="form.website" placeholder="მაგ: motivation.ge">
                  <span  class="text-danger">{{ errors[0] }}</span>
...
export default {
  ...
  methods: {
    ...
    submitForm(){
      ...
      axios.post(process.env.VUE_APP_BACKEND_URL+'/auth/details/add_detail',{'data':this.form}, {
        headers: {
  ...
  mounted() {
    ...
    this.profile_name=user_info.user.name;
    this.profile_mobile=user_info.user.mobile;
    setTimeout(() => {
      this.isLoading = false
    }, 300)
  }
