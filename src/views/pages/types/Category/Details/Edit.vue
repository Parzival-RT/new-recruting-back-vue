      ...
      <div class="container-fluid p-4">
          ...
          <div class="col-12">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">კატეგორიის რედაქტირება</li>
              </ol>
            </nav>
          </div>
          <!-- End Col -->
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center bg-light">
            <span class="font-weigt-bold">კატეგორიის რედაქტირება</span>
          </div>
          <div class="card-body">
            <!-- End Form -->
...
export default {
  ...
  methods:{
    ...
    submitForm(){
      ...
      axios.put(process.env.VUE_APP_BACKEND_URL+'/auth/Categories/update/'+this.$route.params.id, this.form , {
        headers: {
    ...
    getDataById(){
      this.isLoading = true;
      const token = JSON.parse(localStorage.getItem('user')).access_token;
      axios.get(process.env.VUE_APP_BACKEND_URL+'/auth/Categories/get_by_id/'+this.$route.params.id, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      })
