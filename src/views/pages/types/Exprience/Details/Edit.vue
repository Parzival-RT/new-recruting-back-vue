      ...
      <div class="container-fluid p-4">
        ...
        <div class="row mb-3">
          ...
          <div class="col-12">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item text-primary"><router-link to="/WorkExperience">სამუშაო გამოცდილება</router-link></li>
                <li class="breadcrumb-item" aria-current="page">სამ. გამოცდილების რედაქტირება</li>
              </ol>
            </nav>
          </div>
          <!-- End Col -->
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center bg-light">
            <span class="font-weigt-bold">სამ. გამოცდილების რედაქტირება</span>
          </div>
          <div class="card-body">
            <!-- End Form -->
            <form class="row" v-on:submit.prevent="submitForm">
              ...
              <div class="col-12 mb-3">
                ...
                <img class="img-fluid w-25 mt-4" :src="form.file_url">
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      dropzoneLogoOptions: {
        ...
        url: process.env.VUE_APP_BACKEND_URL+'/auth/experience/upload_photo',
        headers: {
          'Cache-Control': null,
  ...
  methods:{
    ...
    submitForm(){
      ...
      axios.put(process.env.VUE_APP_BACKEND_URL+'/auth/experience/update/'+this.$route.params.id, this.form , {
        headers: {
    ...
    getDataById(){
      this.isLoading = true;
      const token = JSON.parse(localStorage.getItem('user')).access_token;
      axios.get(process.env.VUE_APP_BACKEND_URL+'/auth/experience/get_by_id/'+this.$route.params.id, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      })
