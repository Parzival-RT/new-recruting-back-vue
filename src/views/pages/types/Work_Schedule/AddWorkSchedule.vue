      ...
      <div class="container-fluid p-4">
          ...
          <div class="col-12">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">სამ. გრაფიკის დამატება</li>
              </ol>
            </nav>
          </div>
          <!-- End Col -->
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center bg-light">
            <span class="font-weigt-bold">დაამატე სამ. გრაფიკი</span>
          </div>
          <div class="card-body">
            <!-- End Form -->
...
export default {
  ...
  methods: {
    ...
    submitForm(){
      ...
      axios.post(process.env.VUE_APP_BACKEND_URL+'/auth/WorkSchedule/create', this.form , {
        headers: {
