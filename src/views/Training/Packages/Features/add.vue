        ...
        <div class="container-fluid training p-4">
            ...
            <div class="col-12">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">უპირატესობის დამატება</li>
                </ol>
              </nav>
            </div>
            <!-- End Col -->
          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center bg-light">
              <span class="font-weigt-bold">დაამატე უპირატესობა</span>
            </div>
            <div class="card-body">
              <!-- End Form -->
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      axios.post(process.env.VUE_APP_BACKEND_URL + '/auth/packages/sub/create', this.form, {
        headers: {
        ...
        .then((res) => {
          ...
          this.$router.push('/Features/'+this.form.package_id);
        })
        .catch((error) => {
          this.isLoading = false;
