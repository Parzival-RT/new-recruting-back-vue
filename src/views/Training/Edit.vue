      ...
      <div class="container-fluid training p-4">
          ...
          <div class="col-12">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">ტრენინგის რედაქტირება</li>
              </ol>
            </nav>
          </div>
          <!-- End Col -->
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center bg-light">
            <span class="font-weigt-bold">ტრენინგის რედაქტირება</span>
          </div>
          <div class="card-body">
            <!-- End Form -->
            <form class="row" v-on:submit.prevent="submitForm">
              ...
              <div class="col-12 mb-3">
                ...
                <ckeditor v-model="form.desc" placeholder="აღწერა"></ckeditor>
              </div>
              ...
              <div class="col-12 mb-3">
                ...
                <img class="w-25 mt-3" :src="form.file">
              </div>
              <div class="col-12 mb-3">
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      axios.put(process.env.VUE_APP_BACKEND_URL + '/auth/traning/update/' + this.$route.params.id, this.form, {
        headers: {
  ...
  watch: {
    'form.payment_type': function (newVal, oldVal) {
      if (newVal.id == 'free') {
        this.form.payment_type.text = 'ერთიანი გადახდა';
      }
    }
  }
}
